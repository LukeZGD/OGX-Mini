#ifndef _PS3V2_DESCRIPTORS_H_
#define _PS3V2_DESCRIPTORS_H_
...
static_assert(sizeof(InReport) == 49, "PS3V2::InReport size mismatch");
...
static_assert(sizeof(OutReport) == 48, "PS3V2::OutReport size mismatch");
...
static_assert(sizeof(BTInfo) == 17, "PS3V2::BTInfo size mismatch");
...
// Added for V2 magic packet 0xF4
static constexpr uint8_t OUTPUT_0xF4[] = {
    0x42, 0x0c, 0x00, 0x00};

} // namespace PS3V2

#endif // _PS3V2_DESCRIPTORS_H_
